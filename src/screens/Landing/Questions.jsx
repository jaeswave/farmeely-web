...
const Questions = () => {
  ...
  return (
    <section className="bg-customSkyblue bg-opacity-[10%] py-16 px-6 md:px-16">
      <div className=" max-w-4xl mx-auto text-center">
        <h1 className="text-[1.5REM] font-urbanist">
          G O T Q U E S T I O N ?
        </h1>
        <h2 className="text-3xl md:text-4xl font-bold font-urbanist">
          We sure have answers for you!
        </h2>
      </div>
